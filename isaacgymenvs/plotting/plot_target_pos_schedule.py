...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("-i", "--input-filepath", type=str, default='/home/robohike/A1_IsaacGym/IsaacGymEnvs/isaacgymenvs/data/motions/quadruped/mania_pos/motion7.txt' )
